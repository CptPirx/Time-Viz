...
from TSNE.parametric_tSNE import Parametric_tSNE
from TSNE.parametric_tSNE.utils import get_multiscale_perplexities
...
if __name__ == "__main__":
    ...
    transformer_list = [{'label': 'Multiscale tSNE', 'tag': 'tSNE_multiscale', 'perplexity': None, 'transformer': None},
                        ...
                        {'label': 'tSNE (Perplexity=100)', 'tag': 'tSNE_perp100', 'perplexity': 100,
                         'transformer': None},
                        {'label': 'tSNE (Perplexity=500)', 'tag': 'tSNE_perp500', 'perplexity': 500,
                         'transformer': None}]
